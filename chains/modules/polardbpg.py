...
class EmbeddingStore(BaseModel):
    ...
    embedding: sqlalchemy.Column = sqlalchemy.Column(Vector(1024))
...
class PolarDBPG(VectorStore):
    """
    VectorStore implementation using PolarDBPG.
    ###PolarDBPG is a distributed full PostgresSQL syntax cloud-native database.
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        """Run similarity search with PolarDBPG with distance.
    ...
    def similarity_search_with_score_by_vector(
        ...
        results: List[QueryResult] = (
            session.query(
                EmbeddingStore,
                self._distance_fn()(EmbeddingStore.embedding).label("distance"),
            )
            .filter(filter_by)
