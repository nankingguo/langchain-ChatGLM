...
class RDSPG(VectorStore):
    """
    VectorStore implementation using RDSPG.
    ###RDSPG is a distributed full PostgresSQL syntax cloud-native database.
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        """Run similarity search with RDSPG with distance.
